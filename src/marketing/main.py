...
def train():
    ...
    try:
        Marketing().crew().train(n_iterations=int(sys.argv[1]), filename=sys.argv[2], inputs=inputs)
...
def replay():
    ...
    """
    try:
        Marketing().crew().replay(task_id=sys.argv[1])
...
def test():
    ...
    try:
        Marketing().crew().test(n_iterations=int(sys.argv[1]), eval_llm=sys.argv[2], inputs=inputs)
